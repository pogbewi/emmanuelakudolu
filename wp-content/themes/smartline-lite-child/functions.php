...
function smartline_enqueue_scripts() {
	...
	wp_enqueue_style( 'font-awesome', get_template_directory_uri() . '/fontawesome/css/font-awesome.min.css', array(), '3.4.1' );
	...
	// FlexSlider JS
	wp_enqueue_script( 'custom-main', get_template_directory_uri() .'/js/main.js', array( 'jquery' ), '2.6.0' );
